...
import (
	...
	v1beta2 "github.com/tektoncd/triggers/pkg/client/listers/triggers/v1beta2"
...
type EventListenerInformer interface {
	...
	Lister() v1beta2.EventListenerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TriggersV1beta2().EventListeners(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TriggersV1beta2().EventListeners(namespace).Watch(context.TODO(), options)
			},
		},
		&triggersv1beta2.EventListener{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventListenerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&triggersv1beta2.EventListener{}, f.defaultInformer)
}

func (f *eventListenerInformer) Lister() v1beta2.EventListenerLister {
	return v1beta2.NewEventListenerLister(f.Informer().GetIndexer())
}
